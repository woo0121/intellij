...
//				.antMatchers("/favicon.ico").permitAll()
				...
				.antMatchers("/cart","/memberJoin","/memberUpdate","/menu_catagory","/myPage","/orderStatus","/review_tab","/selectRest","/payorder","/user/details","/payment/save","/selectOptions","/updateOrder","/cart/delete","/create").permitAll()
